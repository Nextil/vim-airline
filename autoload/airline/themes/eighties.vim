...
""""""""""""""""""""""""""""""""""""""""""""""""
" Base colors
let s:base03  = {'t': 16,  'g': '#2d2d2d'}
let s:base02  = {'t': 59,  'g': '#393939'}
let s:base01  = {'t': 59,  'g': '#515151'}
let s:base00  = {'t': 101, 'g': '#747369'}
let s:base0   = {'t': 144, 'g': '#a09f93'}
let s:base1   = {'t': 188, 'g': '#d3d0c8'}
let s:base2   = {'t': 188, 'g': '#e8e6df'}
let s:base3   = {'t': 231, 'g': '#f2f0ec'}
let s:yellow  = {'t': 221, 'g': '#ffcc66'}
let s:orange  = {'t': 209, 'g': '#f99157'}
let s:red     = {'t': 210, 'g': '#f2777a'}
let s:magenta = {'t': 176, 'g': '#cc99cc'}
let s:violet  = {'t': 173, 'g': '#d27b53'}
let s:blue    = {'t': 68,  'g': '#6699cc'}
let s:cyan    = {'t': 80,  'g': '#66cccc'}
let s:green   = {'t': 114, 'g': '#99cc99'}
...
let g:airline#themes#eighties#inactive = airline#themes#generate_color_map(
            \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
            \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
            \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
            \ s:NFa)

let g:airline#themes#eighties#normal = airline#themes#generate_color_map(
            \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
            \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
            \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]],
            \ s:NFa)

let g:airline#themes#eighties#normal_modified = {
...
let g:airline#themes#eighties#insert = airline#themes#generate_color_map(
            \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
            \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
            \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]],
            \ s:IFa)

let g:airline#themes#eighties#insert_modified = {
...
let g:airline#themes#eighties#visual = airline#themes#generate_color_map(
...
let g:airline#themes#eighties#visual_modified = {
